...
// Structural data (slugs, image paths, links) stays in the component;
// JSON holds only translated copy. Arrays line up by index with the
// "treatments.items" and "concerns.items" arrays in skin.json.
...
const concernLinks = [
  "/skin/acne-treatment-malaysia/",
  "/skin/acne-scar-treatment-malaysia/",
  "/skin/pigmentation-treatment-malaysia/",
  "/skin/melasma-treatment-malaysia/",
  "/skin/mole-removal-malaysia/",
  "/skin/hydrafacial-malaysia/",
  "/skin/dark-eye-circle-treatment-malaysia/",
  "/skin/rosacea-treatment-malaysia/",
  "/skin/eczema-treatment-malaysia/",
  "/skin/keloid-treatment-malaysia/",
  "/skin/stretch-mark-removal-malaysia/",
  "/skin/laser-hair-removal-malaysia/",
  "/skin/tattoo-removal-malaysia/",
  "/skin/skin-whitening-treatment-malaysia/",
  "/contact-us/",
];
...
export default function SkinHub() {
  const t = useTranslations("skin.skin");
